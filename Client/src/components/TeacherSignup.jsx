...
import student from "../assets/young-teacher-standing-front-blank-260nw-692240155.webp";
...
function TeacherSignup() {
  ...
  return (
    <div className="w-full p-5 h-full bg-slate-300 flex justify-center gap-9 items-center">
      <div className='w-1/2  p-2 h-full bg-white shadow-xl justify-center shadow-black rounded-lg flex items-center'>
